...
import {
    View, Text, StyleSheet, TouchableOpacity, Image, Modal, TouchableNativeFeedback,
    TextInput
} from 'react-native';
...
class CheckoutScreen extends Component {
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={{ flex: 9 }}>
                        ...
                        }}>Delivery Details</Text>
                        {
                            ...
                            <View style={{ flex: 7, marginLeft: 30 }}>
                                ...
                                <View style={{ flexDirection: 'row', flex: 1, alignItems: 'center' }}>
                                    ...
                                    <Text style={{ fontSize: 18, flex: 3 }}>{this.state.phoneNumber}</Text>
                                </View>
                            </View>
                        }
                        {
                        ...
                        <Text style={{
                            fontSize: 25, marginTop: 20, flex: 1, alignSelf: 'center', borderTopWidth: 1,
                            borderTopColor: 'gray', paddingLeft: 10, paddingRight: 10, paddingTop: 10
                        }}>
                            {'Total Amount to Pay: ₹' + this.props.route.params.totalAmount}
                        </Text>
                        <Text style={{
                            marginLeft: 10, marginRight: 10, alignSelf: 'center',
                            flex: 1, paddingLeft: 10, paddingRight: 10, width: '90%', textAlign: 'center'
                        }}>
                ...
                <Modal
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                        <View style={{
                            alignItems: 'center', width: '70%', height: '30%', elevation: 5, borderRadius: 10,
                            backgroundColor: 'white', padding: 10,
                            justifyContent: this.state.orderUploadingError ? 'flex-start' : 'center'
                        }}>
                            <View
                            ...
                            {
                                this.state.orderUploadingError && <View style={{ alignItems: 'center' }}>
                            ...
                            {
                                this.state.orderUploading && <View
                                    style={{ alignItems: 'center' }}>
                                    <Text style={styles.errorMessageText}>Placing order. Please wait!</Text>
                                    <LoadingView />
                                </View>
                            }
                            {
                                ...
                                <View style={{ alignItems: 'center' }}>
                                    ...
                                    >
                                        <Text style={styles.errorMessageButton}>
                                            Okay
                                        </Text>
                                    </TouchableOpacity>
                                </View>
    ...
    placeOrderPressed = async () => {
        ...
        this.setState({
            ...
            orderPlacedPopup: !(nameError || addressError || pincodeError || phoneNumberError),
            orderUploading: !(nameError || addressError || pincodeError || phoneNumberError),
            orderUploadingError: false
        });
        ...
        if (!(nameError || addressError || pincodeError || phoneNumberError)) {
            ...
            if (responseJSON != null) {
                ...
                this.setState({ orderUploading: false, orderUploadingError: true });
        }
    }
    ...
    getOrderErrorMsg = () => {
        if (this.state.orderUploadingErrorMsg)
            ...
            return 'Unable to place order. Check network and try again.'
    }
